...
| Sprint 3 | 15/09/2026 | HU-07 a HU-11 | **En curso.** HU-07 y HU-09 completas: proyecto de React con su estructura, enrutador y página de error ([08](08-estructura-del-proyecto.md)); navegación y página de inicio ([09](09-navegacion-e-inicio.md)). Reglas de seguridad, índices y archivos de despliegue ya estaban en el repositorio. Falta crear los proyectos de Firebase y Vercel ([guía](06-puesta-en-marcha.md)). |
